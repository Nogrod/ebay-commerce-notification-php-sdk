...
------------ | ------------- | ------------- | -------------
*ConfigApi* | [**getNotificationConfig**](docs/Api/ConfigApi.md#getnotificationconfig) | **GET** /config | 
...
- [DestinationStatusEnum](docs/Model/DestinationStatusEnum.md)
...
- [SubscriptionFilterStatus](docs/Model/SubscriptionFilterStatus.md)
...
- [SubscriptionTestResponse](docs/Model/SubscriptionTestResponse.md)
