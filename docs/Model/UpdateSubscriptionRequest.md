...
**status** | [**\eBay\Commerce\Notification\Model\SubscriptionStatusEnum**](SubscriptionStatusEnum.md) | Set the status of the subscription being updated to &lt;code&gt;ENABLED&lt;/code&gt; or &lt;code&gt;DISABLED&lt;/code&gt;. | [optional]
