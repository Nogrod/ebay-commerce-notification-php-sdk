...
class PublicKeyApi
{
     ...
     * @return \eBay\Commerce\Notification\Model\PublicKey|\eBay\Commerce\Notification\Model\Error
     */
    public function getPublicKey(
        string $public_key_id,
        string $contentType = self::contentTypes['getPublicKey'][0]
    ): \eBay\Commerce\Notification\Model\PublicKey|\eBay\Commerce\Notification\Model\Error {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \eBay\Commerce\Notification\Model\PublicKey|\eBay\Commerce\Notification\Model\Error, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
