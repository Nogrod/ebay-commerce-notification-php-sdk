...
class TopicApi
{
     ...
     * Operation getTopic
     *
     * @param  string $topic_id The unique identifier of the notification topic for which the details are retrieved. Use &lt;a href&#x3D;\&quot;/develop/api/sell/notification_api#sell-notification_api-topic-gettopics\&quot;&gt;getTopics&lt;/a&gt; to retrieve the topic ID. (required)
     ...
     * @return \eBay\Commerce\Notification\Model\Topic|\eBay\Commerce\Notification\Model\Error
     */
    public function getTopic(
        string $topic_id,
        string $contentType = self::contentTypes['getTopic'][0]
    ): \eBay\Commerce\Notification\Model\Topic|\eBay\Commerce\Notification\Model\Error {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \eBay\Commerce\Notification\Model\Topic|\eBay\Commerce\Notification\Model\Error, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \eBay\Commerce\Notification\Model\TopicSearchResponse|\eBay\Commerce\Notification\Model\Error
     */
    public function getTopics(
        ?string $continuation_token = null,
        ?string $limit = null,
        string $contentType = self::contentTypes['getTopics'][0]
    ): \eBay\Commerce\Notification\Model\TopicSearchResponse|\eBay\Commerce\Notification\Model\Error {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \eBay\Commerce\Notification\Model\TopicSearchResponse|\eBay\Commerce\Notification\Model\Error, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
