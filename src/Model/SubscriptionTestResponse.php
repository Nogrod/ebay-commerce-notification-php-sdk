...
/**
 * SubscriptionTestResponse Class Doc Comment
 *
 ...
 */
class SubscriptionTestResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'SubscriptionTestResponse';
     ...
     *
     * @param string|null $notification_id The unique identifier for the notification for this test message.
     *
     * @return $this
     */
