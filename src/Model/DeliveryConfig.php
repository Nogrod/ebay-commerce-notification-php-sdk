...
class DeliveryConfig implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DeliveryConfig';
    ...
    */
     ...
     * Sets endpoint
     *
     * @param string|null $endpoint The endpoint for this destination.<br><br><span class=\"tablenote\"><b>Note:</b> The provided endpoint URL should use the HTTPS protocol, and it should not contain an internal IP address or <code>localhost</code> in its path.</span>
     *
     * @return $this
     */
