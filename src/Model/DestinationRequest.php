...
class DestinationRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'DestinationRequest';
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['delivery_config'] === null) {
            $invalidProperties[] = "'delivery_config' can't be null";
        }
     ...
     *
     * @return \eBay\Commerce\Notification\Model\DeliveryConfig
     */
    public function getDeliveryConfig(): \eBay\Commerce\Notification\Model\DeliveryConfig
    {
     ...
     *
     * @param \eBay\Commerce\Notification\Model\DeliveryConfig $delivery_config This container is used to specify the destination endpoint and verification token associated with this endpoint.
     *
     * @return $this
     */
    public function setDeliveryConfig(\eBay\Commerce\Notification\Model\DeliveryConfig $delivery_config): static
    {
     ...
     * Sets name
     *
     * @param string|null $name The seller-specified name for the destination endpoint.
     *
     * @return $this
     */
