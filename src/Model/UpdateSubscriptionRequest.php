...
class UpdateSubscriptionRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets destination_id
     *
     * @param string|null $destination_id The unique identifier of the destination endpoint that will receive notifications associated with this subscription. Use <b>getDestinations</b> to retrieve destination IDs.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status Set the status of the subscription being updated to ENABLED or DISABLED. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/commerce/notification/types/api:SubscriptionStatusEnum'>eBay API documentation</a>
     *
     * @return $this
     */
