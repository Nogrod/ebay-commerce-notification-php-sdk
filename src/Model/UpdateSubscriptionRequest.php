...
class UpdateSubscriptionRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Sets destination_id
     *
     * @param string|null $destination_id The unique identifier of the destination endpoint that will receive notifications associated with this subscription. Use <a href=\"/develop/api/sell/notification_api#sell-notification_api-destination-getdestinations\">getDestinations</a> to retrieve destination IDs.
     *
     * @return $this
     */
     ...
     * Sets payload
     *
     * @param \eBay\Commerce\Notification\Model\SubscriptionPayloadDetail|null $payload The payload associated with this subscription.
     *
     * @return $this
     */
