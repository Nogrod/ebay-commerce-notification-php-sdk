...
class SubscriptionPayloadDetail implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SubscriptionPayloadDetail';
    ...
    */
     ...
     * Sets format
     *
     * @param string|null $format The supported data format of the payload.<br><br><span class=\"tablenote\"><b>Note:</b> JSON is currently the only supported format for all notification topics.</span> For implementation help, refer to <a href='https://developer.ebay.com/api-docs/commerce/notification/types/api:FormatTypeEnum'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Sets schema_version
     *
     * @param string|null $schema_version The supported schema version for the notification topic. See the <b>supportedPayloads.schemaVersion</b> field for the topic in <b>getTopics</b> or <b>getTopic</b> response.
     *
     * @return $this
     */
