...
class SubscriptionPayloadDetail implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Sets schema_version
     *
     * @param string|null $schema_version The supported schema version for the notification topic. See the <b>supportedPayloads.schemaVersion</b> field for the topic in <a href=\"/develop/api/sell/notification_api#sell-notification_api-topic-gettopics\">getTopics</a> or <a href=\"/api-docs/commerce/notification/resources/topic/methods/getTopic\">getTopic</a> response.
     *
     * @return $this
     */
