...
class Config implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'Config';
    ...
    {
        $this->setIfExists('alert_email', $data ?? [], null);
    }
     ...
     * Sets alert_email
     *
     * @param string|null $alert_email This field is used to add or modify an email address that will be used for Notification API alerts associated with the application. <b>getConfig</b> can be used to get the email address currently being used for alerts.
     *
     * @return $this
     */
    public function setAlertEmail(?string $alert_email): static
    {
        if (is_null($alert_email)) {
            throw new InvalidArgumentException('non-nullable alert_email cannot be null');
        }
